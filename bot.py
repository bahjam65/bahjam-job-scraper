...
JSEARCH_QUERIES = {
    1: ["Junior motion designer remote", "3D motion graphic designer", "3D animation remote", "AI artist"],
    2: ["3D designer", "music video artist", "motion graphics artist remote", "AI aniamtion artist remote"],
    3: ["video editor remote", "VFX artist", "3D music video remote", "visual artist"],
}

_DEFAULT_SKILLS = [
    "3D design", "3D animation", "3D motion design", "motion graphics",
    "blender", "after effects", "marvelous designer", "parametric design",
    "interactive animation", "Unreal Engine", "Embergen",
    "vfx design", "touch designer", "3D modeling", "interior design",
]
...
BOOST_KEYWORDS = {
    "blender": 20, "3D animation": 18, "visual": 15,
    "junior": 18, "entry level": 15, "associate": 12,
    "music video": 12, "visual designer": 12, "video editor": 10,
